    ...
    <main class="main-section">
        <section class="departments-section">
            ...
            <div class="departments-container">
                ...
                <div class="department-card">
                    <h3>Orthopedics</h3>
                    <p>Bone, joint, and muscular treatments.</p>
                </div>
                <div class="department-card">
                    <h3>Pediatrics</h3>
                ...
                <div class="department-card">
                    <h3>Radiology</h3>
                    <p>Medical imaging and diagnostic services.</p>
                </div>
                <div class="department-card">
                    <h3>Emergency</h3>
                ...
                <div class="department-card">
                    <h3>Dermatology</h3>
                    <p>Skin-related treatments and care.</p>
                </div>
                <div class="department-card">
                    <h3>Oncology</h3>
                    <p>Cancer treatment and therapies.</p>
                </div>
                <div class="department-card">
                    <h3>Gynecology</h3>
                ...
                <div class="department-card">
                    ...
                    <p>Treatment for ear, nose, and throat disorders.</p>
                </div>
                <div class="department-card">
                    <h3>Urology</h3>
                    <p>Kidney and urinary tract care.</p>
                </div>
                <div class="department-card">
                    <h3>Gastroenterology</h3>
                    <p>Digestive system treatments.</p>
                </div>
                <div class="department-card">
                    <h3>Psychiatry</h3>
                ...
                <div class="department-card">
                    <h3>Physiotherapy</h3>
                    <p>Physical rehabilitation and therapy.</p>
                </div>
            </div>
        </section>
    </main>
